...
# snakemake <- new("smake",input=list("sensor_connectivity_df"="../data/interim/sensor_connectivity_df.csv",
#                                     "pcc_df"=glue('../data/interim/{nw_type}/{nw_type}_df_human.csv'),
#                                     "pcc_df_random"=glue('../data/interim/{nw_type}/{nw_type}_df_random_500_human.csv')))
...
# nw_type = 'pombe'
# snakemake <- new("smake",input=list("sensor_connectivity_df"="../data/interim/sensor_connectivity_df.csv",
#                                     "pcc_df"=glue('../data/interim/{nw_type}/{nw_type}_df_corr.csv'),
#                                     "pcc_df_random"=glue('../data/interim/{nw_type}/{nw_type}_df_random_500_corr.csv')))
...
```{r}
combined_rewire_df %>% filter(type != "real")%>%summary()
```
...
```{r}
  ...
  figure_folder = glue("../reports/figures/paper_figures_{nw_type}/")
