...
ggsave('reports/figures/paper_figures_1213_pcc_only/fig1.png', width=4,height=4)
...
deg_scatter_plots <- cowplot::plot_grid(pcc_deg_eff, pcc_deg_sens,
                    labels = c('D','E'),
                   ncol=2)
ggsave('reports/figures/paper_figures_1213_pcc_only/fig2.png',plot=deg_scatter_plots, width=10,height=10)
```
...
distr_plots <- plot_grid(
 ...
 p4+theme(legend.position=''),labels=c('F','G'),nrow=1 )
...
plot_grid(dens_plots, deg_scatter_plots, distr_plots_withlgn, nrow=3,rel_heights = c(0.4,0.3,.3))
ggsave('reports/figures/paper_figures_1213_pcc_only/fig3.png',width=10,height=12)
```
...
ggsave('reports/figures/paper_figures_1213_pcc_only/fig5.pdf',width=6,height=6)
