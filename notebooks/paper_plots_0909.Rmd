...
with open(f'data/interim/gi_1201/gi_100.pickle','rb') as f:
    e_gi = pickle.load(f)
...
title <- cowplot::ggdraw() + cowplot::draw_label("Costanzo 2016 network", fontface='bold')
...
title <- cowplot::ggdraw() + cowplot::draw_label("Costanzo 2016 network GI", fontface='bold')
gi_dens_comb = cowplot::plot_grid(gi_degree_dens+theme(legend.position='none'), 
                                gi_eff_dens+theme(legend.position='none'), 
                                gi_sensitivity_dens+theme(legend.position='none'), labels=c('A','B','C'),ncol=3)
...
yuri_dens_comb = cowplot::plot_grid(yuri_degree_dens+theme(legend.position='none'), 
                                ...
                                yuri_sensitivity_dens+theme(legend.position='none'), labels=c('D','E','F'),ncol=3)
...
huri_dens_comb = cowplot::plot_grid(huri_degree_dens+theme(legend.position='none'), 
                                ...
                                huri_sensitivity_dens+theme(legend.position='none'), labels=c('G','H','I'),ncol=3)
...
ggsave('reports/figures/paper_figures_1204_withgi/fig1.png')
...
deg_scatter_plots <- cowplot::plot_grid(pcc_deg_eff, pcc_deg_sens,
                   ...
                   huri_deg_eff, huri_deg_sens, labels = c('A','','B','','C',''),
                   ncol=2)
...
gi_rewire_df = read_csv('data/interim/gi_1201/rewire_data.csv')
...
```{r}
network_labels  <- c('Costanzo 2016','Costanzo GI','Yeast PPI','HuRI')
...
distr_plots <- plot_grid(
 ...
 nrow=3, labels=c('D','E','','F','G',''), rel_heights = c(0.45,0.45,0.1))
...
ggsave('reports/figures/paper_figures_1204_withgi/fig3.png',width=8,height=9)
```
