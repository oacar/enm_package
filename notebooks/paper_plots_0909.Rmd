...
pcc_degree_dens <- 
    ...
    #facet_grid(rows=vars(data))+
    #geom_density()+
    geom_line(data=     pcc_df%>%filter(group=='real'),aes(x=deg,y=..scaled..,color=group),stat = 'density')+#, binwidth = 0.1) + 
    geom_line(data=     pcc_df%>%filter(group=='random'),aes(x=deg,y=..scaled.., color=group, fill=random_id),stat = 'density',linetype = "dashed")+#, binwidth = 0.1) + 
    theme_bw()+
    xlab('Degree')+
    ylab('Density')+
    coord_trans(x = "log10")+
...
pcc_eff_dens <- 
    ...
    #facet_grid(rows=vars(data))+
#    geom_density()+
    geom_line(data= pcc_df%>%filter(group=='real'),
               aes(x=eff_norm ,y=..scaled.., color=group),
               stat = 'density')+#, binwidth = 0.1) + 
    geom_line(data= pcc_df%>%filter(group=='random'),
               aes(x=eff_norm ,y=..scaled..,fill=random_id, color=group),
...
#    geom_density()+
    geom_line(data= pcc_df%>%filter(group=='real'),
               ...
               stat = 'density')+#, binwidth = 0.1) + 
    geom_line(data= pcc_df%>%filter(group=='random'),
               aes(x=sens_norm,y=..scaled..,fill=random_id,color=group),
               stat = 'density',linetype = "dashed")+#, binwidth = 0.1) + 
    #geom_histogram(binwidth=0.0001)+
    theme_bw()+
    xlab('Sensitivity')+
...
yuri_degree_dens <- 
    ...
    #facet_grid(rows=vars(data))+
    #geom_density()+
    geom_line(data=     yuri_df%>%filter(group=='real'),aes(x=deg,y=..scaled..,color=group),stat = 'density')+#, binwidth = 0.1) + 
    geom_line(data=     yuri_df%>%filter(group=='random'),aes(x=deg,y=..scaled.., color=group, fill=random_id),stat = 'density',linetype = "dashed")+#, binwidth = 0.1) + 
    theme_bw()+
    xlab('Degree')+
    ylab('Density')+
    coord_trans(x = "log10")+
...
yuri_eff_dens <- 
    ...
    #facet_grid(rows=vars(data))+
#    geom_density()+
    geom_line(data= yuri_df%>%filter(group=='real'),
               aes(x=eff_norm ,y=..scaled.., color=group),
               stat = 'density')+#, binwidth = 0.1) + 
    geom_line(data= yuri_df%>%filter(group=='random'),
               aes(x=eff_norm ,y=..scaled..,fill=random_id, color=group),
               stat = 'density',linetype = "dashed" )+#, binwidth = 0.1) + 
    #geom_histogram(binwidth=0.0001)+
    theme_bw()+
...
huri_degree_dens <- 
    ...
    #facet_grid(rows=vars(data))+
    #geom_density()+
    geom_line(data=     huri_df%>%filter(group=='real'),aes(x=deg,y=..scaled..,color=group),stat = 'density')+#, binwidth = 0.1) + 
    geom_line(data=     huri_df%>%filter(group=='random'),aes(x=deg,y=..scaled.., color=group, fill=random_id),stat = 'density',linetype = "dashed")+#, binwidth = 0.1) + 
    theme_bw()+
    xlab('Degree')+
    ylab('Density')+
    coord_trans(x = "log10")+
...
huri_eff_dens <- 
    ...
    #facet_grid(rows=vars(data))+
#    geom_density()+
    geom_line(data= huri_df%>%filter(group=='real'),
               aes(x=eff_norm ,y=..scaled.., color=group),
               stat = 'density')+#, binwidth = 0.1) + 
    geom_line(data= huri_df%>%filter(group=='random'),
               aes(x=eff_norm ,y=..scaled..,fill=random_id, color=group),
               stat = 'density',linetype = "dashed" )+#, binwidth = 0.1) + 
    #geom_histogram(binwidth=0.0001)+
    theme_bw()+
...
dens_plots = cowplot::plot_grid(pcc_dens_comb_title,
                                ...
                                huri_dens_comb_title,nrow=3)
cowplot::plot_grid(dens_plots, dens_lgn,nrow=2,rel_heights=c(.9,.1))
ggsave('reports/figures/paper_figures_0916/fig1.png')
...
deg_scatter_plots <- cowplot::plot_grid(pcc_deg_eff, pcc_deg_sens,
                   ...
                   ncol=2)
ggsave('tmp.png',plot=deg_scatter_plots, width=10,height=10)
...
combined_rewire_df <- rewire_df%>%select(data, eff_deg_pearson,sens_deg_spearman)%>%mutate(type = 'random')%>% 
    bind_rows(
    data.frame(sens_deg_spearman= c(cor(pcc_df[pcc_df$group=='real',]$deg, pcc_df[pcc_df$group=='real',]$sens,method='spearman'),cor(yuri_df[yuri_df$group=='real',]$deg,yuri_df[yuri_df$group=='real',]$sens,method='spearman'),cor(huri_df[huri_df$group=='real',]$deg,huri_df[huri_df$group=='real',]$sens,method='spearman')), eff_deg_pearson= c(cor(pcc_df[pcc_df$group=='real',]$deg, pcc_df[pcc_df$group=='real',]$eff,method='pearson'),cor(yuri_df[yuri_df$group=='real',]$deg,yuri_df[yuri_df$group=='real',]$eff,method='pearson'),cor(huri_df[huri_df$group=='real',]$deg,huri_df[huri_df$group=='real',]$eff,method='pearson')), type='real',data=c('pcc','yuri','huri')))%>%
    mutate(data= fct_relevel(data, c('pcc','yuri','huri')))
...
ggsave('reports/figures/paper_figures_0916/fig2.png',width=8,height=9)
```
